...
public class Main {
	...
	public static void LireDonnees(String input_file_name) 
	{
				...
				try {
					lecteur = new BufferedReader(new FileReader("C:\\Users\\erwan\\OneDrive\\Documents\\ApprenonsJava\\eclipse\\p2_CSI2510_BigTable\\src\\test.txt"));//("src/test.txt"));
	...
	public static void Lire() throws IOException 
	{
		...
		BufferedReader in = new BufferedReader(new FileReader("C:\\Users\\erwan\\OneDrive\\Documents\\ApprenonsJava\\eclipse\\p2_CSI2510_BigTable\\src\\p2_CSI2510_BigTable\\input2.txt"));
		String line = null;
		try {
